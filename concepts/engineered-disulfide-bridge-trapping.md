...
- [Outward-Facing Conformation of ABC Transporters](/xray-mp-wiki/concepts/outward-facing-conformation/) — The trapping method validates the outward-facing conformation in a non-ABC transporter
- [Alternating Access Mechanism](/xray-mp-wiki/concepts/alternating-access-mechanism/) — Conformational trapping enables study of transport cycle states
