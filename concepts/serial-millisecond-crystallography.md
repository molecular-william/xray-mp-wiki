...
- [High-Viscosity Sample Injection for SFX](/xray-mp-wiki/concepts/high-viscosity-sample-injection-for-sfx/) — The high-viscosity injectors developed for SFX are directly adapted for SMX.
- [In Situ Crystallography](/xray-mp-wiki/concepts/in-situ-crystallography/) — Related room-temperature crystallography approach.
...
- [Native SAD Phasing](/xray-mp-wiki/concepts/long-wavelength-native-sad-phasing/) — SMX data quality enables native-SAD phasing using sulfur anomalous scattering.
