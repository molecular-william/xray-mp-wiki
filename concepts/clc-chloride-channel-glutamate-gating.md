...
## Related Concepts
- [CLC Two-Gate Transport Mechanism](/xray-mp-wiki/concepts/clc-two-gate-mechanism/) — In CLC transporters, both Glu148 (external gate) and Tyr445 (internal gate) are used, while CLC channels use only the glutamate gate for fast gating
- [Selectivity Filter](/xray-mp-wiki/concepts/selectivity-filter/) — The glutamate gate operates within the Cl- selectivity filter of CLC channels, occupying the extracellular anion binding site
