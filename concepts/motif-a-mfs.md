...
- [Major Facilitator Superfamily (MFS)](/xray-mp-wiki/concepts/major-facilitator-superfamily/) — Motif A is a defining signature of the MFS transporter family
- [Rocker-Switch Mechanism](/xray-mp-wiki/concepts/rocker-switch-mechanism/) — Motif A regulates the rocker-switch conformational changes in MFS transporters
