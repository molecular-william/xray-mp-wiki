...
- [[zntb-transporter]] — Distant homolog; zinc/cadmium exporter with similar pentameric architecture
- [[mfs-transporter]] — Major facilitator superfamily (different family)
- [[kirbac]] — Potassium channel; tetrameric architecture comparison