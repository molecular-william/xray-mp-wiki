...
- Lactose Permease (LacY) — Unphosphorylated EIIA^Glc binds to and inhibits LacY, an [MFS](/xray-mp-wiki/concepts/protein-families/major-facilitator-superfamily/) transporter. Binding of EIIA^Glc to LacY is enhanced by the presence of lactose substrate. The mechanism is likely different from the [Maltose](/xray-mp-wiki/reagents/additives/maltose/) transporter since LacY is an [MFS](/xray-mp-wiki/concepts/protein-families/major-facilitator-superfamily/) transporter rather than an ABC transporter.
- [Melibiose](/xray-mp-wiki/reagents/ligands/melibiose/) Permease ([MELB](/xray-mp-wiki/proteins/mfs-transporters/melb/)) — Unphosphorylated EIIA^Glc binds to and inhibits [MELB](/xray-mp-wiki/proteins/mfs-transporters/melb/), another [MFS](/xray-mp-wiki/concepts/protein-families/major-facilitator-superfamily/) transporter. Binding of EIIA^Glc to [MELB](/xray-mp-wiki/proteins/mfs-transporters/melb/) is enhanced by the presence of the corresponding sugar substrate, similar to LacY.
