...
- [Aquaporin](/xray-mp-wiki/concepts/aquaporin/) — Aquaporins have also been used to study protein-lipid interactions in crystalline environments, showing ordered lipid molecules surrounding the protein.
...
- [Hydrophobic Gating](/xray-mp-wiki/concepts/hydrophobic-gating/) — Related concept involving hydrophobic interactions at membrane interfaces
- [Lipid Annulus](/xray-mp-wiki/concepts/lipid-annulus/) — The first-layer phospholipids surrounding membrane proteins form the lipid annulus
