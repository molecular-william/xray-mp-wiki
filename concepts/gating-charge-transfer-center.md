...
- [Voltage-Sensor Paddle](/xray-mp-wiki/concepts/voltage-sensor-paddle/) — The S3b-S4 paddle carries the gating charges that translocate through the transfer center
