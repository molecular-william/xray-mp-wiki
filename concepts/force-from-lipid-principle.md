...
## Mechanism/Details
The FFL principle is supported by several lines of evidence from MscS studies:
First, the transmembrane region of MscS contains hydrophobic pockets between transmembrane helices that are filled by lipid acyl chains. When membrane tension increases, phospholipids repartition from the protein pockets to the bulk bilayer, destabilizing the closed conformation and favoring the open state. This lipid repartitioning is the missing component of tension-sensing models.
Second, lysolipids (single-acyl-chain phospholipids such as LPC 18:1) enter the pockets and displace normal diacyl phospholipids. Because lysolipids cannot fully fill the pocket volume, they reduce the extent of acyl-chain interdigitation and destabilize the closed state, triggering channel opening at lower tension.
...
- **MscS (Mechanosensitive Channel of Small Conductance)**: The primary model for
  the FFL principle. Lipid-filled pockets between transmembrane helices serve as
  the mechanosensitive element. Lysolipids (LPC) displace normal phospholipids
  and trigger opening.
...
- **TRAAK (KCNK4)**: A mechanosensitive K2P channel where membrane tension
...
## Cross-References
- [E. coli MscS (Mechanosensitive Channel of Small Conductance)](/xray-mp-wiki/proteins/mscs/) — Primary model system for the FFL principle
- [Human TRAAK Potassium Channel](/xray-mp-wiki/proteins/traak/) — Eukaryotic mechanosensitive channel with lipid-mediated gating
