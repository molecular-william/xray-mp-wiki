...
- **[KCSA](/xray-mp-wiki/proteins/voltage-gated-channels/kcsa/) (Streptomyces lividans)**: The primary model system for studying
  ...
  [Protein Truncation for Crystallization](/xray-mp-wiki/concepts/truncation/) via chymotrypsin treatment widens the inner gate opening and reduces
  coupling efficiency.
