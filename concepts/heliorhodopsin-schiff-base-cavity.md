...
## Related Concepts
- [Retinal Chromophore Conformation](/xray-mp-wiki/concepts/retinal-chromophore-conformation/) — The RSB is part of the retinal chromophore; the SBC directly interacts with the RSB
- [Rhodopsin Photocycle](/xray-mp-wiki/concepts/rhodopsin-photocycle/) — The SBC water cluster mediates proton transfer during the HeR photocycle
- [Proton Wire](/xray-mp-wiki/concepts/proton-wire/) — The hydrogen bonding network in the SBC functions as a proton wire connecting RSB to Arg104 and protein surface
