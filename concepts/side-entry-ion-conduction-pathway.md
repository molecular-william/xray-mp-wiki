...
- [Ion Channel Selectivity Filter](/xray-mp-wiki/concepts/selectivity-filter/) — Side-entry permeation is a non-canonical mechanism for ion passage through the selectivity filter
