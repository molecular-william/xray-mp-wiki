...
## Related Concepts
- [Low-Barrier Hydrogen Bond](/xray-mp-wiki/concepts/low-barrier-hydrogen-bond/) — The 2.3-2.4 Å H-bonds in the BR PRG are LBHBs containing delocalized protons
- [Bacteriorhodopsin Photocycle](/xray-mp-wiki/concepts/bacteriorhodopsin-photocycle/) — The PRG evolves through the photocycle, with LBHBs in ground/K/L states and ionic lock in M state
- [Proton Wire](/xray-mp-wiki/concepts/proton-wire/) — The PRG is connected to D85 via a linear CHB that mediates long-range signaling for proton release
...
- [Rhodopsin Photocycle](/xray-mp-wiki/concepts/rhodopsin-photocycle/) — PRC participates in proton release step of the photocycle
- [Low-Barrier Hydrogen Bond](/xray-mp-wiki/concepts/low-barrier-hydrogen-bond/) — The short H-bonds in the PRG are the primary examples of LBHBs in a membrane protein
- [Merohedral Twinning in Protein Crystallography](/xray-mp-wiki/concepts/merohedral-twinning/) — The 2.3 A bR structure is a classic example of merohedral twinning in membrane protein crystallography
