...
## Related Concepts
- [Allosteric Regulation](/xray-mp-wiki/concepts/structural-mechanisms/allosteric-regulation/) — 3FTs bind allosterically to GPCR extracellular vestibules
- [Negative Allosteric Modulation](/xray-mp-wiki/concepts/signaling-receptors/negative-allosteric-modulation/) — MT7 acts as a NAM for M1AChR agonist activation
- [Positive Allosteric Modulation](/xray-mp-wiki/concepts/structural-mechanisms/positive-allosteric-modulation/) — MT7/Tx24 act as PAMs for orthosteric antagonist binding
- [Extracellular Domain GPCR Allostery](/xray-mp-wiki/concepts/signaling-receptors/extracellular-domain-gpcr-allostery/) — 3FT binding occurs at the extracellular vestibule allosteric site
