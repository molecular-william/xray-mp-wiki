...
- [Calcium Bowl](/xray-mp-wiki/concepts/calcium-bowl/) — Related Ca2+ coordination concept; MCU uses a carboxylate ring for Ca2+ selectivity
- [Intramembrane Ion Coordination](/xray-mp-wiki/concepts/intramembrane-ion-coordination/) — MCU's Glu336 ring represents an intramembrane Ca2+ coordination site
