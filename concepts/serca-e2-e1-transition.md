...
- [P-type ATPase Mechanism](/xray-mp-wiki/concepts/p-type-atpase-mechanism/) — The E2→E1 transition is a fundamental step in the P-type ATPase catalytic cycle
- [Phosphoenzyme E2P State](/xray-mp-wiki/concepts/phosphoenzyme-e2p-state/) — The E2P state follows the E2→E1→E1P transitions in the reaction cycle
