---
title: Two-Stage Catalytic Mechanism of Rhomboid Proteases
created: 2026-05-28
updated: 2026-05-28
type: concept
category: concepts
...
# Two-Stage Catalytic Mechanism of Rhomboid Proteases

## Overview
Rhomboid intramembrane proteases catalyze substrate cleavage through a two-stage mechanism consisting of an interrogation complex and a scission complex. In the interrogation stage, the substrate transmembrane segment initially binds laterally to the gate-open form of the protease without contacting the catalytic center. This provides a kinetic pause during which substrates that can unwind extend toward the active site, while non-substrates are ejected. The scission stage occurs when the substrate transitions to the catalytic complex and is cleaved.
