...
## Related Concepts
- [Light-Adapted State](/xray-mp-wiki/concepts/light-adapted-state/) — Opposite conformational state where all-trans retinal is exclusively favored
- [Retinal Isomerization](/xray-mp-wiki/concepts/retinal-isomerization/) — Thermal cis-trans isomerization in DA state driven by water network dynamics
- [Rhodopsin Photocycle](/xray-mp-wiki/concepts/rhodopsin-photocycle/) — DA state serves as starting point for the light-driven photocycle
...
- [Light-Adapted State](/xray-mp-wiki/concepts/light-adapted-state/) — Complementary concept describing the ground state of microbial rhodopsins
