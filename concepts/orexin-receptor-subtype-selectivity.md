...
## Related Concepts
- [GPCR Active Conformation](/xray-mp-wiki/concepts/gpcr-active-conformation/) — Structure-based design targeting subtype selectivity relies on understanding active and inactive conformations
- [GPCR G Protein Coupling](/xray-mp-wiki/concepts/gpcr-g-protein-coupling/) — Subtype-selective antagonists can dissect the physiological roles of closely related GPCRs
