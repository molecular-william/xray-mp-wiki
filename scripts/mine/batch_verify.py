...
files = [
    "acetylcholine-binding-protein", "af-tmem16", "arabidopsis-nitrate-transporter-nrt1-1",
    "betp", "bpe-fluoride-channel", "claudin-19-mouse", "clbm",
    "clostridium-boltrea-mray", "clpp", "cmclc", "cp-tric", "cysz",
    "cytochrome-b561", "cytochrome-b5-reductase", "cytochrome-b5",
    "d4-dopamine-receptor", "dgot", "fluc-ec2", "glt-ph",
    "human-claudin-4", "human-claudin-9"
]
