...
pairs = {
    ...
    "arabidopsis-nitrate-transporter-nrt1-1": [
        ("4CL4", "10.1038/nature13116"),
        ("4CL5", "10.1038/nature13116"),
        ("5A2N", "10.1038/nature13116"),
    ],
    "betp": [
        ("2WIT", "10.1038/nature07819"),
        ("3HFX", "10.1038/nsmb.1788"),
        ("4C7R", "10.1038/emboj.2013.226"),
        ("4DOJ", "10.1038/nature11403"),
        ("3JEO", "10.1038/nature07819"),
        ("4AIN", "10.1038/nature11403"),
        ("4AMR", "10.1038/nature11403"),
    ],
    "bpe-fluoride-channel": [
        ("5A40", "10.1038/nature14981"),
        ("5A41", "10.1038/nature14981"),
        ("6BQO", "10.1016/j.str.2018.02.004"),
    ],
    ...
    "cytochrome-b5": [
        ("4YMK", "10.1038/nature14549"),
        ("6WF2", "10.1016/j.jmb.2020.05.017"),
        ("2I96", "10.1016/j.jmb.2020.05.017"),
    ],
    ...
    "fluc-ec2": [
        ("5A40", "10.1038/nature14981"),
        ("5KBN", "10.7554/eLife.18767"),
        ("6B24", "10.7554/eLife.31259"),
        ("7KKR", "10.7554/eLife.69482"),
        ("5A43", "10.7554/eLife.31259"),
        ("6B2A", "10.7554/eLife.31259"),
        ("6B2B", "10.7554/eLife.31259"),
        ("6B2D", "10.7554/eLife.31259"),
        ("7KKA", "10.7554/eLife.69482"),
        ("7KKB", "10.7554/eLife.69482"),
        ("7KK8", "10.7554/eLife.69482"),
        ("7KK9", "10.7554/eLife.69482"),
        ("5kom", "10.7554/eLife.18767"),
    ],
    "glt-ph": [
        ("1XFH", "10.1038/nature03018"),
        ("2NWL", "10.1038/nature05455"),
        ("3KBC", "10.1038/nature08616"),
        ("3V8F", "10.1038/nsmb.2233"),
        ("4IZM", "10.1038/nsmb.2548"),
        ("4P19", "10.7554/eLife.02283"),
        ("4X2S", "10.1038/nature14158"),
        ("5DWY", "10.1038/ncomms13420"),
        ("6V8G", "10.15252/embj.2020105415"),
        ("6X01", "10.1038/s41586-021-03240-9"),
        ("7AHK", "10.1126/sciadv.aba9854"),
    ],
...
for protein, pdb_list in sorted(pairs.items()):
    for pdb, doi in pdb_list:
        result = subprocess.run(["python3", str(CHECK_SCRIPT), pdb, doi], capture_output=True, text=True, cwd=str(BASE))
