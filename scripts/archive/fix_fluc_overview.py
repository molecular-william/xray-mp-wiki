...
with open('/home/wtliaf/Desktop/Research/coding_projects/xray-mp-wiki/xray-mp-wiki/proteins_yaml/fluc-ec2.yaml', 'r') as f:
    content = f.read()
...
if idx > 0:
    ...
    if end_idx > 0:
        ...
        with open('/home/wtliaf/Desktop/Research/coding_projects/xray-mp-wiki/xray-mp-wiki/proteins_yaml/fluc-ec2.yaml', 'w') as f:
            f.write(new_content)
