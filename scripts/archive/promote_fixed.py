...
files = [
    'human-dhhc20', 'human-ebp', 'human-ep4-receptor',
    'human-glut3', 'human-glyt1', 'human-endothelin-etb-receptor-et1',
    'kv1-2-2-1-3m-channel', 'kv1-2-2-1-2m-channel', 'kv1-2-2-1-v406w',
    'ktrb', 'leubat', 'human-connexin-26-gap-junction-channel',
    'human-dopamine-d3-receptor', 'human-endothelin-etb-receptor-irl2500',
    'human-histamine-h1-receptor', 'human-histamine-h3-receptor', 'human-k2p1-twik-1'
]
