...
content = content.replace("    4DOJ: doi/10.1038##nature11403", "    4DOJ: doi/10.1038##nature11403" + additions)
...
content = content.replace("    7AHK: doi/10.1126##sciadv.aba9854", "    7AHK: doi/10.1126##sciadv.aba9854" + additions)
content = re.sub(r"verified: regex", "verified: agent", content)
with open(fp, "w") as f:
    f.write(content)
print("Fixed glt-ph")
