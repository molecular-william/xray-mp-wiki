...
9. Solve structures at each time point by [Molecular Replacement](/xray-mp-wiki/methods/structure-determination/molecular-replacement/)
...
|---|---|---|---|
| [Channelrhodopsin C1C2](/xray-mp-wiki/proteins/rhodopsins/channelrhodopsin-c1c2/) | 1.7-2.8 | 7E6X, 7E6Z, 7E70, 7E71 | TR-SFX at SACLA XFEL captured 6 time points (dark, 1 us, 50 us, 250 us, 1 ms, 4 ms) revealing early conformational changes in TM3 and TM7 |
| [Bacteriorhodopsin](/xray-mp-wiki/proteins/rhodopsins/bacteriorhodopsin/) | 2.1 | 5B6V, 5B6W, 5H2H, 5H2I, 5H2J, 5B6X, 5H2K, 5H2L, 5H2M, 5B6Y, 5H2N, 5H2O, 5H2P, 5B6Z | TR-SFX at SACLA XFEL captured 13 time points from 16 ns to 1.725 ms at 2.1 A resolution, revealing the 3D movie of structural changes in the bR photocycle. Dark state PDB 5B6V. Time points: 5B6W (16 ns), 5H2H (40 ns), 5H2I (110 ns), 5H2J/5B6X (290/760 ns), 5H2K (2 μs), 5H2L (5.25 μs), 5H2M (13.8 μs), 5B6Y (36.2 μs, M state), 5H2N (95.2 μs), 5H2O (250 μs), 5H2P (657 μs), 5B6Z (1.725 ms, M state). M-state half-rise 15 ± 7 μs, half-decay 8 ± 3 ms. |
| [Photosystem II](/xray-mp-wiki/proteins/photosynthesis/photosystem-ii/) | 5.0 | 4PBU | TR-SFX at LCLS CXI captured dark S1 state; gas focusing liquid injector at 10 °C; 120 Hz FEL |
| [Photosystem II](/xray-mp-wiki/proteins/photosynthesis/photosystem-ii/) | 5.5 | 4Q54 | TR-SFX at LCLS captured double-flash putative S3 state; revealed Mn4CaO5 elongation during S2-S3 transition |
| [Photosystem II](/xray-mp-wiki/proteins/photosynthesis/photosystem-ii/) | 2.35 | 5WS5, 5WS6 | TR-SFX at SACLA XFEL on T. vulcanus PSII at 2.35 A; pre-flashed with [Potassium Ferricyanide](/xray-mp-wiki/reagents/additives/potassium-ferricyanide/); revealed O=O bond formation site (O6 near O5) |
