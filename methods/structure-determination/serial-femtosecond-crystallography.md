...
For membrane proteins, the **LCP-SFX** (lipidic cubic phase [serial-femtosecond-crystallography](/methods/structure-determination/serial-femtosecond-crystallography.html)) method was developed:
- Microcrystals are grown and suspended in LCP ([monoolein](/methods/crystallization/monoolein.html)-based mesophase)
...
- [xray-crystallography](/methods/structure-determination/xray-crystallography.html) — X-ray crystallography overview
- [lipidic-cubic-phase](/methods/crystallization/lipidic-cubic-phase.html) — LCP crystallization method
- [cryoem](/methods/structure-determination/cryoem.html) — Cryo-EM alternative for challenging targets