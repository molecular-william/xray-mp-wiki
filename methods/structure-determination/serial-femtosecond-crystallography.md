...
For membrane proteins, the **LCP-SFX** (lipidic cubic phase [[serial-femtosecond-crystallography]]) method was developed:
- Microcrystals are grown and suspended in LCP ([[monoolein]]-based mesophase)
...
- [[xray-crystallography]] — X-ray crystallography overview
- [[lipidic-cubic-phase]] — LCP crystallization method
- [[cryoem]] — Cryo-EM alternative for challenging targets