...
- [affinity-chromatography](/methods/purification/affinity-chromatography.html) — Broad category of purification methods using specific binding interactions
- [talon-resin](/methods/purification/talon-resin.html) — TALON cobalt affinity resin (Co2+ IMAC variant)
- [superdex-columns](/methods/purification/superdex-columns.html) — SEC for final polishing after IMAC
- [size-exclusion-chromatography](/methods/purification/size-exclusion-chromatography.html) — Alternative/complementary purification method
