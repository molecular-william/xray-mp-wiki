...
|---|---|---|---|
| [Chicken Kir2.2](/xray-mp-wiki/proteins/Chicken Kir2.2/) | N/A (functional study) | 3SPI | Inside-out patch clamp was used to demonstrate PIP2-mediated activation of Kir2.2. Endogenous PIP2 depletion causes run-down; exogenous short-chain PIP2 restores activity in a dose-dependent manner. |
