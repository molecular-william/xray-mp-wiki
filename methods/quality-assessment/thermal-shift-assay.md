...
sources: [doi/10.1016##j.str.2017.12.013, doi/10.1016##j.str.2008.04.013, doi/10.1016##j.str.2018.01.005]
verified: false
---
...
1. {'step': 'CPM stock preparation', 'method': 'Dissolve CPM at 4 mg/ml in dimethylformamide; further diluted 1:1000 v/v in sample buffer', 'notes': 'Sample buffer: 50 mM HEPES pH 7.0, 150 mM NaCl, 0.05% DDM, 0.01% CHS'}
...
|---|---|---|---|
| [A2AAR-S91A](/xray-mp-wiki/proteins/A2AAR-S91A/) | not applicable | 5WF6 | Thermal shift assays used to characterize stability of S91A variant with panel of pharmacological ligands |
| [PepT_St Proton-Dependent Oligopeptide Transporter](/xray-mp-wiki/proteins/PepT_St Proton-Dependent Oligopeptide Transporter/) | not applicable | -- | DSF used for peptide binding screen of 28 different di- and tripeptides; thermal stability peaked at pH 4.5; 100 mM HEPES pH 7.0, 150 mM NaCl, 0.03% DDM used in purification buffer; NM (nonylmaltoside) used for DSF to maximize peptide stabilization signal |
| [A2AAR-D52N](/xray-mp-wiki/proteins/A2AAR-D52N/) | not applicable | 5WF5 | Thermal shift assays used to compare stability of A2AR-D52N vs wild-type A2AR across multiple ligands; apo A2AAR-D52N showed ~8 C increase in Tm over apo A2AAR |
