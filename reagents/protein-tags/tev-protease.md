...
- [nTMATE2-transporter](/proteins/nTMATE2-transporter/) — TEV(S219V) protease variant used
...
- [etb-receptor](/proteins/etb-receptor/) — TEV protease cleavage between G57 and L66 to remove N-terminal Flag tag and disordered region; GFP-His₁₀ tag and TEV removed by TALON resin after cleavage
...
- [talon-resin](/methods/purification/talon-resin/) — His-tag affinity capture (tag removed by TEV)
- [superdex-columns](/methods/purification/superdex-columns/) — SEC to separate cleaved tag and TEV protease