...
- [[etb-receptor]] — 0.1% LMNG in TALON wash buffer; 0.01% LMNG in elution and SEC buffers (combined with 0.001% CHS)

- [[nTMATE2-transporter]] — 0.03% in purification and SEC buffer, combined with 0.003% CHS
  - Replaces DDM after [[affinity-chromatography]] capture for improved stability during size-exclusion chromatography

## Related Detergents

- [[ddm]] — standard non-ionic maltoside, used for initial solubilization
- [[og]] — shorter chain alkyl glucoside
- [[ogng]] — octyl [[glucose]] neopentyl glycol; octyl-chain analogue of LMNG
