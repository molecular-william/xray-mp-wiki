...
- **Class**: Non-ionic detergent (glycoside-based)
- **Name origin**: "Anzergent" — proprietary detergent from Anatrace (formerly Anatrace/Mega)
- **Structure**: Alkyl polyglucoside with optimized alkyl chain length and degree of polymerization
- **Common concentration**: 0.5–2% (w/v) for membrane protein solubilization

## Properties

- **Mildness**: Gentle solubilization suitable for preserving protein-protein interactions and complex integrity
- **Low CMC**: Favors stable micelle formation at low concentrations
- **Temperature stability**: Effective at room temperature and physiological temperatures
- **Compatibility**: Compatible with downstream purification and crystallization

## Use in KirBac Crystallization
