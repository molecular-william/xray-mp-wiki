...
OG is used to solubilize [Opsin (Retinal-Free Rhodopsin)](/xray-mp-wiki/proteins/gpcr/opsin/) from retinal disc membranes at pH 5.6, promoting formation of the active Ops* conformation. A single OG molecule was found bound in the retinal-binding pocket of Ops* at 2.65 A resolution, replacing retinal and forming a defined hydrogen-bond network with multiple hydroxy groups. This binding stabilizes the active G-protein-interacting state of the receptor.


### Ligand-binding pocket probe

OG and related alkyl glucosides (NG, HpG) can occupy the retinal-binding pocket of [Opsin (Retinal-Free Rhodopsin)](/xray-mp-wiki/proteins/gpcr/opsin/) in a chain-length-dependent manner, with maximal inhibition of reconstitution observed above the critical micellar concentration. This property makes OG useful for probing hydrophobic binding pockets of GPCRs and other membrane proteins.


### Inhibitor of LeuT S2 site and Na+-coupled transport

OG, used as the crystallization detergent for all [LeuT](/xray-mp-wiki/proteins/enzymes/leut/) structures, binds to the second substrate (S2) site in the extracellular vestibule and blocks Na+-coupled substrate symport. The C8 aliphatic tail of OG occupies the S2 site approximately 11 A above the S1 leucine, while the glycoside head group is partially disordered. OG reduces [3H]Leu binding stoichiometry from ~2 to ~1 and acts as a symport uncoupler similar to tricyclic antidepressants (TCAs). All LeuT crystal structures solved in OG represent functionally blocked forms.
...
### Crystallization medium for HiTehA anion channel

beta-Octylglucoside was used as the detergent medium for crystallizing HiTehA, the bacterial homologue of plant SLAC1 anion channel. Crystals grew in space group R3 at 4 degrees C from protein solubilized in beta-octylglucoside, using PEG600 or PEG400 as precipitant, across a pH range of 5.2 to 10.2. The structure was solved at 1.20 A resolution and includes four detergent molecules in the asymmetric unit.
...
|---|---|---|---|
| [Opsin](/xray-mp-wiki/proteins/gpcr/opsin/) | solubilization concentration | Opsin solubilization from disc membranes at pH 5.6 | Active Ops* conformation stabilized; OG found bound in retinal-binding pocket at 2.65 A |
| [Bacteriorhodopsin (Ground State)](/xray-mp-wiki/proteins/rhodopsins/bacteriorhodopsin/) | 0.1% | Separating bR crystals from monoolein lipidic mesophase using 3 M sodium phosphate buffer with 0.1% OG | Crystals separated for X-ray data collection |
| [Squid Rhodopsin](/xray-mp-wiki/proteins/gpcr/squid-rhodopsin/) | 100 mM | Solubilization of C-terminally truncated squid rhodopsin from microvillar membranes; detergent/protein ratio 3.7 (w/w); zinc acetate for selective extraction | Selective extraction of rhodopsin from squid microvillar membranes; used in both extraction and crystallization; hexagonal P62 crystals |
...
- [Opsin (Retinal-Free Rhodopsin)](/xray-mp-wiki/proteins/gpcr/opsin/) — OG found bound in orthosteric binding pocket
- [Bacteriorhodopsin (Ground State)](/xray-mp-wiki/proteins/rhodopsins/bacteriorhodopsin/) — 0.1% OG for crystal separation from lipidic mesophase
- [Squid Rhodopsin (Photoreaction States)](/xray-mp-wiki/proteins/gpcr/squid-rhodopsin/) — Primary detergent for squid rhodopsin extraction
