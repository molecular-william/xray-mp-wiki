...
Forms a conserved hydroxy-amine hydrogen bond network. The benzofuran oxygen forms a hydrogen bond with Ser203 (TM V). The ethyl-carboxylate moiety extends toward Asn293 (TM VI), forming an additional hydrogen bond between the ethoxy oxygen and the amine group of Asn293. This is the only ligand that connects TM V and VI through hydrogen bond networks.

- **Key residues**: Ser203, Asn293
