...
- **Chemical name**: thermolysin
- **Molecular weight**: 34 kDa
- **Class**: metalloprotease (thermostable neutral protease)

## Use in Membrane Protein Work

### Limited proteolysis for crystallization

SppA_BS K199A mutant was digested with thermolysin (500:1 molar ratio) overnight at room temperature to generate a proteolytically resistant fragment starting at Leu51, approximately 8 kDa smaller than the full catalytic domain. The resulting 28 kDa fragment crystallized more readily and was used for structure determination.
