...
Monobody S7 is an engineered protein inhibitor selected from a combinatorial library of designed ankyrin repeat proteins (DARPins) to bind specifically to the fluoride channel from Bordetella pertussis (Bpe). S7 binds to both ends of the Bpe homodimer, extending a long loop of 8-10 angstroms into each channel vestibule, occluding the water-exposed surface and blocking fluoride ion permeation. S7 was used in crystallization of the Bpe-S7 complex (PDB 5A40), solved at 3.6 Angstrom resolution using SAD phasing. S7 binding is mostly hydrophobic, aromatic, and hydrogen-bonded, with weak ionic strength dependence.
