...
- **Chemical name**: methyl (3aR,4S,7aR)-4-hydroxy-4-[(3-methylphenyl)ethynyl]octahydro-1H-indole-1-carboxylate
...
Asn747^5.47 delta-nitrogen hydrogen bonds to carbonyl oxygens of Gly652^3.37 and the carbamate tail. Hydroxyl substituent within hydrogen bonding distance of Ser809^7.39 and Ser805^7.35 hydroxyl oxygens. Trp785^6.50 chi1 trans rotamer (swung-out) critical for binding position.

- **Pocket volume**: Pocket ~8 A from receptor surface, defined by residues from TM2, TM3, TM5, TM6, and TM7. 3-methylphenyl ring between Ala810^7.40 and Pro655^3.40. Alkyne linker traverses channel between Tyr659^3.44, Ser809^7.39, Val806^7.36. Saturated bicyclic ring in hydrophobic pocket defined by Val806^7.36, Met802^7.32, Phe788^6.53, Trp785^6.50, Leu744^5.44, Ile651^3.36, Pro655^3.40, Asn747^5.47.
