...
sources: [doi/10.1021##ja105108q, doi/10.1038##nature06325, doi/10.1038##nature08650]
verified: agent
---
...
Forms the conserved hydroxy-amine hydrogen bond network with the receptor. The allylbenzene head group is smaller than the cyclic systems of other beta2 AR ligands, but the prop-1-ene chain is oriented in the same location as the cyclic systems in other compounds. The decreased resolution (3.1 A) results in lower confidence in ligand placement.
