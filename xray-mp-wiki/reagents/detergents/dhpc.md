...
DHPC is used for crystallization of the Aquifex aeolicus TatC twin-arginine translocation component. AaTatC crystallized in DHPC at 4.0 A resolution (PDB 4HTS), revealing a glove-like structure with a lipid-exposed pocket for signal sequence recognition. The short acyl chains of DHPC may facilitate crystal formation by reducing the detergent micelle size.
...
|---|---|---|---|
| Aquifex aeolicus TatC | Not specified | Solubilization of TatC for crystallization | Crystal structure at 4.0 A resolution (PDB 4HTS) |
