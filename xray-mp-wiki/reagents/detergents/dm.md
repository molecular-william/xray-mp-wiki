...
Decyl-β-D-maltoside (DM) is a mild nonionic detergent with a 10-carbon alkyl chain. It is widely used for solubilizing and purifying membrane proteins while maintaining their native structure and function. In the ScaDMT study, DM was used for membrane protein extraction at 1-2% (w/v) and for purification buffers at 0.25% (w/v). ScaDMT purified in DM was shown to be monomeric by multiangle light scattering (MALS).
...
- [Salmonella enterica Citrate/Sodium Symporter (SeCitS)](/xray-mp-wiki/proteins/slc-transporters/se-cits/) — DM used for solubilization and purification of SeCitS
- [E. coli Fluc-Ec2 Fluoride Ion Channel](/xray-mp-wiki/proteins/other-ion-channels/fluc-ec2/) — DM used for purification of Fluc-Ec2
- [Site-2 Protease (mjS2P) from Methanocaldococcus jannaschii](/xray-mp-wiki/proteins/enzymes/mjs2p/) — DM used as primary crystallization detergent for mjS2P
