...
NBD-PE is the primary fluorescent probe used in lipid scrambling assays to measure the activity of lipid scramblases. NBD-PE is incorporated into the outer leaflet of liposomes, and upon addition of the membrane-impermeable reducing agent sodium dithionite, only the outer-leaflet NBD-PE is quenched. Lipids that flip to the inner leaflet are protected from quenching. The rate of fluorescence recovery upon addition of scramblase protein reflects the scrambling activity.
