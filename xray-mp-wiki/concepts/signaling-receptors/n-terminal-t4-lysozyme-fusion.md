...
## Related Concepts
- [T4 lysozyme fusion strategy](/xray-mp-wiki/concepts/construct-design/t4-lysozyme-fusion-strategy/) — Describes the broader approach of using T4L to facilitate GPCR crystallization
- [GPCR crystallization](/xray-mp-wiki/concepts/methods-techniques/gpcr-crystallization/) — The N-terminal T4L fusion is one method among many for GPCR crystallization
