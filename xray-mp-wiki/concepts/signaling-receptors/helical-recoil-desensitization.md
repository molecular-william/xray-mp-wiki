...
## Overview
The helical recoil model describes the molecular mechanism of P2X receptor desensitization, the process by which continuously activated ligand-gated ion channels transition to a closed, non-conducting state. In this model, the transition from the open to the desensitized state involves two coordinated events: disassembly of the cytoplasmic cap and upward recoiling of transmembrane helix 2 (TM2), which reverts a transient 3_10-helix segment back to an alpha-helix. This mechanism explains how P2X3 receptors undergo rapid and nearly complete desensitization, a key feature distinguishing them from slowly desensitizing P2X subtypes.
...
- **hP2X3 (human P2X3)**: Undergoes rapid and nearly complete desensitization.
  The wild-type receptor shows fast desensitization kinetics with tau of 429 ms.
  Three mutations from rat P2X2 (P19V, S15V, V16I) introduced into hP2X3 slow
  desensitization (tau = 42,581 ms), enabling capture of the open state structure.
- **hP2X3-MFC (minimal functional construct)**: Delta N5/Delta C33 construct
  with P19V/S15V/V16I mutations. Used to crystallize the open state. Kd for
  ATP binding: 3.3 nM. Desensitization tau: 42,581 ms.
- **P2X3-MFC (without mutations)**: Delta N5/Delta C33 construct without
...
## Related Concepts
- Channel gating mechanisms in ligand-gated ion channels - Cytoplasmic cap as a structural element in P2X receptors - Conformational dynamics and desensitization in ion channels - Protein thermostabilization through targeted mutations - Ball-and-chain model of ion channel inactivation
...
- [P2X Receptor Family](/xray-mp-wiki/concepts/signaling-receptors/p2x-receptor-family/) — P2X receptors divided into fast and slow desensitizing subtypes
- [Channel Gating via Plug Domain Displacement](/xray-mp-wiki/concepts/transport-mechanisms/channel-gating/) — Comparison of gating and inactivation mechanisms across ion channel families
- [Protein Thermostabilization](/xray-mp-wiki/concepts/construct-design/thermostabilization/) — Targeted mutations to stabilize specific conformational states of ion channels
