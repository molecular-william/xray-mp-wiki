...
## Related Concepts
- [Bacteriorhodopsin Photocycle](/xray-mp-wiki/concepts/rhodopsin-mechanisms/bacteriorhodopsin-photocycle/) — The photocycle intermediates (I, J, K, L, M) were observed in TR-SFX experiments, though under multiphoton conditions
...
- [Retinal Isomerization](/xray-mp-wiki/concepts/rhodopsin-mechanisms/retinal-isomerization/) — The isomerization yield is affected by multiphoton excitation, with reduced quantum yield at high intensities
- [Light-Adapted State](/xray-mp-wiki/concepts/rhodopsin-mechanisms/light-adapted-state/) — Light adaptation and pre-illumination protocols are critical for ensuring consistent retinal isomer composition in TR-SFX experiments
...
- [Bacteriorhodopsin Photocycle](/xray-mp-wiki/concepts/rhodopsin-mechanisms/bacteriorhodopsin-photocycle/) — Multiphoton effects alter the photocycle dynamics compared to single-photon excitation
- [Retinal Isomerization](/xray-mp-wiki/concepts/rhodopsin-mechanisms/retinal-isomerization/) — Multiphoton excitation reduces the isomerization quantum yield
