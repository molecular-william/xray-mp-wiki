...
## Related Concepts
- [RND efflux pumps](/xray-mp-wiki/concepts/transport-mechanisms/rnd-efflux-pumps/) — MtrCDE belongs to the HAE-RND family of tripartite efflux systems
- [Tripartite drug efflux systems](/xray-mp-wiki/concepts/protein-families/tripartite-drug-efflux-systems/) — MtrCDE is a paradigm tripartite efflux system spanning both bacterial membranes
- [Antibiotic resistance mechanisms](/xray-mp-wiki/concepts/enzyme-mechanisms/antibiotic-resistance-mechanisms/) — Overexpression of MtrCDE contributes to multidrug resistance in N. gonorrhoeae
