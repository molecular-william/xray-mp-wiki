...
## Related Concepts
- [De novo protein design](/xray-mp-wiki/concepts/methods-techniques/de-novo-protein-design/) — Foundational methodology for computational protein structure design
- [Hydrogen bond networks in membrane proteins](/xray-mp-wiki/concepts/structural-mechanisms/hydrogen-bond-networks/) — Central to the design strategy for specifying transmembrane helix packing
